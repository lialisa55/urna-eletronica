...
<div class="container fluid">
  <div class="row">
    ...
    <div class='col-3 mt-5 mx-auto'>
      ...
      <p>290 - Antônio Carlos/PCO</p>
      <p>287 - Janaina Paschoal/PRTB</p>
      <p>300 - Ricardo Mellão/NOVO</p>
      <p>123 - Aldo Rebelo/PDT</p>
    </div>
  </div>
</div>
...
if(isset($_POST['codigo'])){
  if(empty($_POST['codigo'])){
    ...
    $print = mysqli_fetch_array($con->query("SELECT codigo, nome, partido, imagem from tb_senador WHERE codigo = $codigo;"));
...
if(isset($_POST['nome']) && isset($_POST['partido']) && isset($_POST['codigo'])){
    ...
    if(empty($_POST['nome']) || empty($_POST['partido']) || empty($_POST['codigo'])){
        ...
        $select = mysqli_fetch_array($con->query("SELECT votos from tb_senador where codigo = $codigo;"));
  
        $con->query("UPDATE tb_senador set votos = ". $select['votos'] + 1 ." WHERE codigo = $codigo;");
